...
class AuthorityLevelsTest < ApplicationSystemTestCase
  ...
  test "should create authority level" do
    ...
    fill_in "Description", with: @authority_level.description
    fill_in "Max authority", with: @authority_level.max_authority
    fill_in "Min authority", with: @authority_level.min_authority
