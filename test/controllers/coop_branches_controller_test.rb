...
class CoopBranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coop_branch" do
    assert_difference("CoopBranch.count") do
      post coop_branches_url, params: { coop_branch: { address: @coop_branch.address, cooperative_id: @coop_branch.cooperative_id, name: @coop_branch.name } }
    end
  ...
  test "should update coop_branch" do
    patch coop_branch_url(@coop_branch), params: { coop_branch: { address: @coop_branch.address, cooperative_id: @coop_branch.cooperative_id, name: @coop_branch.name } }
