...
class CooperativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cooperative" do
    assert_difference("Cooperative.count") do
      post cooperatives_url, params: { cooperative: { address: @cooperative.address, name: @cooperative.name } }
    end
  ...
  test "should update cooperative" do
    patch cooperative_url(@cooperative), params: { cooperative: { address: @cooperative.address, name: @cooperative.name } }
